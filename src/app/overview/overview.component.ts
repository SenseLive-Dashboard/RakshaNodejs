...
function voltageGraph() {
  ...
  $(document).ready(function () {
    ...
    $.getJSON("http://mayurdafare.ml/APIs/graph_v.php", addData);
  })
}
function powerGraph() {
  ...
  $(document).ready(function () {
    ...
    $.getJSON("http://mayurdafare.ml/APIs/graph_p.php", addData);
  })
}
function activePowerGraph() {
  ...
  $(document).ready(function () {
    ...
    $.getJSON("http://mayurdafare.ml/APIs/graph_apow.php", addData);
  })
}
...
function reactivePowerGraph() {
  ...
  $(document).ready(function () {
    ...
    $.getJSON("http://mayurdafare.ml/APIs/graph_rpow.php", addData);
  })
}
...
function apparentPowerGraph() {
  ...
  $(document).ready(function () {
    ...
    $.getJSON("http://mayurdafare.ml/APIs/graph_app.php", addData);
  })
}
